...
complete -c alp -n '__fish_seen_subcommand_from generate' -l target -d 'Generation target' -a 'zephyr-conf dts-overlay native-sim-overlay cmake-args yocto-conf carrier-netlist'
